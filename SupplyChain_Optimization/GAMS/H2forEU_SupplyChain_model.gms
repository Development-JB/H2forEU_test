...
e_ProductionLimitCapacityNode(YEAR, NODE_PRODUCTION)
...
e_CostDummy(i_YEAR(YEAR))..
    v_CostTotalDummy(YEAR)
    =e=
    v_ProductionDummyEU(YEAR) * 1000000
...
e_CostProduction(i_YEAR(YEAR))..
    v_CostProduction(YEAR)
    =e=
    sum((H2_SYSTEM), v_ProductionH2System(YEAR, H2_SYSTEM) * p_production_volume(YEAR, H2_SYSTEM) * p_production_cost(YEAR, H2_SYSTEM))
;
...
e_CostTransportConversion(i_YEAR(YEAR))..
    ...
    $(LINK_PATH_CONVERSION_NATIONAL(PATH,TRANSPORT_CONVERSION)),
    v_Path(YEAR, PATH)*p_transport_conversion_cost(YEAR, TRANSPORT_CONVERSION))
    + sum((PATH, TRANSPORT_CONVERSION)
    $(LINK_PATH_CONVERSION_INTERNATIONAL(PATH,TRANSPORT_CONVERSION)),
    v_Path(YEAR, PATH)*p_transport_conversion_cost(YEAR, TRANSPORT_CONVERSION))
*    + sum((PATH, TRANSPORT_CONVERSION)
...
e_Demand_EU(i_YEAR(YEAR))..
    p_demand_eu(YEAR)
    =e=
    v_ProductionDummyEU(YEAR)
    + sum((PATH),v_Path(YEAR, PATH))
;
...
e_LinkH2SystemNodeProduction(i_YEAR(YEAR), NODE_PRODUCTION)..
    v_ProductionNode(YEAR, NODE_PRODUCTION)
    =e=
    sum((H2_SYSTEM)$(LINK_H2_SYSTEM_NODE_PRODUCTION(H2_SYSTEM,NODE_PRODUCTION) and p_production_cost(YEAR, H2_SYSTEM)>0),v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_volume(YEAR, H2_SYSTEM))
;
...
e_ProductionLimitVolumesNode(i_YEAR(YEAR), NODE_PRODUCTION, ENERGY_TYPE)..
    p_production_limit_volume_node(YEAR, NODE_PRODUCTION, ENERGY_TYPE)
    =g=
    sum((H2_SYSTEM, SOURCE_NON_VRES)$(LINK_H2_SYSTEM_SOURCE(H2_SYSTEM, SOURCE_NON_VRES) and LINK_H2_SYSTEM_NODE_PRODUCTION(H2_SYSTEM,NODE_PRODUCTION) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacity(YEAR, H2_SYSTEM, ENERGY_TYPE)) 
;

e_ProductionLimitCapacityNode(i_YEAR(YEAR), NODE_PRODUCTION)..
    p_production_limit_capacity_node(YEAR, NODE_PRODUCTION)
    =g=
    sum((H2_SYSTEM, ENERGY_TYPE, SOURCE_VRES)$(LINK_H2_SYSTEM_SOURCE(H2_SYSTEM, SOURCE_VRES)and LINK_H2_SYSTEM_NODE_PRODUCTION(H2_SYSTEM,NODE_PRODUCTION) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacity(YEAR, H2_SYSTEM, ENERGY_TYPE)) 
;

e_ProductionLimitAreaNode(i_YEAR(YEAR), NODE_PRODUCTION)..
    p_production_area_available_node(NODE_PRODUCTION)
    =g=
    sum((H2_SYSTEM, ENERGY_TYPE, SOURCE_VRES)$(LINK_H2_SYSTEM_SOURCE(H2_SYSTEM, SOURCE_VRES)and LINK_H2_SYSTEM_NODE_PRODUCTION(H2_SYSTEM,NODE_PRODUCTION) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacity(YEAR, H2_SYSTEM, ENERGY_TYPE)*p_production_energy_density(ENERGY_TYPE)*p_production_land_dedication(ENERGY_TYPE)) 
;

e_ProductionLimitCountry(i_YEAR(YEAR), COUNTRY_EXPORT, ENERGY_TYPE)..
    p_production_limit_country(YEAR, COUNTRY_EXPORT, ENERGY_TYPE)
    =g=
    sum((H2_SYSTEM, SOURCE_VRES)$(LINK_H2_SYSTEM_SOURCE(H2_SYSTEM,SOURCE_VRES) and LINK_H2_SYSTEM_COUNTRY(H2_SYSTEM,COUNTRY_EXPORT) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacity(YEAR, H2_SYSTEM, ENERGY_TYPE))
;
