...
e_ProductionLimitCapacityNode(i_YEAR(YEAR), NODE_PRODUCTION)..
    ...
    =g=
    sum((H2_SYSTEM, ENERGY_TYPE, SOURCE_VRES)$(LINK_H2_SYSTEM_SOURCE(H2_SYSTEM, SOURCE_VRES)and LINK_H2_SYSTEM_NODE_PRODUCTION(H2_SYSTEM,NODE_PRODUCTION) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacities(YEAR, H2_SYSTEM, ENERGY_TYPE)) 
;
...
e_ProductionLimitCountry(i_YEAR(YEAR), COUNTRY_IMPORT, ENERGY_TYPE)..
    ...
    =g=
    sum((H2_SYSTEM)$(LINK_H2_SYSTEM_COUNTRY(H2_SYSTEM,COUNTRY_IMPORT) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacities(YEAR, H2_SYSTEM, ENERGY_TYPE))
;
