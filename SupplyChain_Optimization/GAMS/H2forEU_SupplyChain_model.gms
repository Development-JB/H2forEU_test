...
e_ProductionLimitCountry(i_YEAR(YEAR), COUNTRY_IMPORT, ENERGY_TYPE)..
    p_production_limit_country(YEAR, COUNTRY_IMPORT, ENERGY_TYPE)
    =g=
    sum((H2_SYSTEM)$(LINK_H2_SYSTEM_COUNTRY(H2_SYSTEM,COUNTRY_IMPORT) and LINK_H2_SYSTEM_ENERGY_TYPE(H2_SYSTEM,ENERGY_TYPE)), v_ProductionH2System(YEAR, H2_SYSTEM)*p_production_capacity(YEAR, H2_SYSTEM, ENERGY_TYPE))
;
