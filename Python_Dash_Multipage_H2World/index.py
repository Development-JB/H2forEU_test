...
lst_dashboards = [
                    ...
                    # 'page_map_system_capacity_utilization',
                    # 'page_sankey',
                    # 'marco_dummy'
                   ]
...
app.layout = html.Div([
    ...
    dbc.Nav([
                ...
                # dbc.NavItem(dbc.NavLink('RES production distribution', href='/apps/page_res_utilization')),
                # dbc.NavItem(dbc.NavLink('RES capacity utilization', href='/apps/page_map_system_capacity_utilization')),
...
def display_page\
   ...
   elif ('page_map_system_capacity_utilization' in lst_dashboards) and (pathname == '/apps/page_map_system_capacity_utilization'):
       return page_map_system_capacity_utilization.layout
