...
val_path_settings = Path(str(LCOH_config_general.wd_l2)+"//Data//01Input//Settings.xls")
val_path_data_general = Path(str(LCOH_config_general.wd_l2)+"//Data//01Input//Data_general.xls")
val_path_inputs = str(LCOH_config_general.wd_l2)+"//Data//01Input//"
val_path_templates = str(LCOH_config_general.wd_l2)+"//Data//00Templates//"
