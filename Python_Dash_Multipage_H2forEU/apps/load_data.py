...
def fct_load_results_supply():
    ...
    df_results = pd.merge(df_results, df_transport_national_cost_variable, how='left',
                          on=['Year', 'Transport_national'])
    df_results = pd.merge(df_results, df_transport_national_distance, how='left',
    ...
    df_results = pd.merge(df_results, df_transport_international_cost_fixed, how='left',
                          on=['Year', 'Transport_international'])
    df_results = pd.merge(df_results, df_transport_international_cost_variable, how='left',
                          on=['Year', 'Transport_international'])
    df_results = pd.merge(df_results, df_transport_international_distance, how='left',
    ...
    df_results['Lcoh_cif'] = df_results['Lcoh_fob'] + df_results['Transport_international_cost'] + df_results[
        'Transport_conversion_cost']
