...
def page_lcoh_update_graph(slct_system, slct_electrolyser):
    ...
    df_slct = df_slct[df_slct['Year'] == 2020]
    if slct_system == 'Best':
    ...
    fig = px.choropleth(df_slct, locations='NUTS_ID', geojson=json_nuts2, color='LCOH')
